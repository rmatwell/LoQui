...
public class MonthlyEyeProgressActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        dbWorker.getMonthlyScores(newReport, cal.getDisplayName(Calendar.MONTH, Calendar.LONG, Locale.ENGLISH), 3);
            ...
            public void onFinish() {
                ...
                for (int i = 0; i < newReport.monthlyReport.size(); i++)
                {
                    ...
                    for (int k = 0; k < newReport.monthlyReport.get(i).dailyList.size(); k++)
                    {
                        ...
                        if (newReport.monthlyReport.get(i).dailyList.get(k).getScore() > 0)
                        {
                            numCorrect = numCorrect + newReport.monthlyReport.get(i).dailyList.get(k).getScore();
                ...
                axis.setTextSize(16);
                axis.setName("Month of April Eye Contact Progress");
