...
public class Task3_question extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hint.setText("Pick all of the " + correct_emotion + " faces. Hint: There's only " + num_correct_answers +"!");
...
oid sha256:f745a889ee2c04d6248f69cd19c73e12a1aa0ec0389aa0fb9833a14f9d7d9341
size 15187
